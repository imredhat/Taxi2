...
const styles = StyleSheet.create({
  ...
  docBtn: {
    minHeight: 120, borderWidth: 1.5, borderColor: '#dfe8e4', borderRadius: 18,
    backgroundColor: '#fff', overflow: 'hidden', borderStyle: 'dashed',
  },
  docImage: { width: '100%', height: 120, resizeMode: 'cover' },
  docPlaceholder: {
    flex: 1, alignItems: 'center', justifyContent: 'center', height: 120,
  },
  docIcon: { fontSize: 32 },
