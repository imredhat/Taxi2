jQuery(document).ready(function($) {
  ...
  $('#default').click(function(){
    ...
    var linkcss = 'http://old3.commonsupport.com/wp/conexi/wp-content/themes/conexi/assets/';

    $('link[rel*=jquery]').remove();

    $('head').append('<link rel="stylesheet jquery" href="'+linkcss+'css/color.php?main_color=FFC000" type="text/css" />');
